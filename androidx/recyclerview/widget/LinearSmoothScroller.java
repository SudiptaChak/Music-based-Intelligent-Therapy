...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
  ...
  protected void onTargetFound(View paramView, RecyclerView.State paramState, RecyclerView.SmoothScroller.Action paramAction) {
    int k = calculateDxToMakeVisible(paramView, getHorizontalSnapPreference());
    int j = calculateDyToMakeVisible(paramView, getVerticalSnapPreference());
    int i = calculateTimeForDeceleration((int)Math.sqrt((k * k + j * j)));
    if (i > 0)
      paramAction.update(-k, -j, i, (Interpolator)this.mDecelerateInterpolator); 
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\LinearSmoothScroller.class
