  ...
  static class Bucket {
    ...
    void insert(int param1Int, boolean param1Boolean) {
      if (param1Int >= 64) {
        ...
        long l2 = this.mData;
        this.mData = (l2 & (l1 ^ 0xFFFFFFFFFFFFFFFFL)) << 1L | l2 & l1;
        if (param1Boolean) {
          set(param1Int);
        } else {
          clear(param1Int);
    ...
    boolean remove(int param1Int) {
      ...
      long l1 = this.mData & (l2 ^ 0xFFFFFFFFFFFFFFFFL);
      this.mData = l1;
      l2--;
      this.mData = l1 & l2 | Long.rotateRight((l2 ^ 0xFFFFFFFFFFFFFFFFL) & l1, 1);
      Bucket bucket = this.mNext;
      if (bucket != null) {
        if (bucket.get(0))
          set(63); 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\ChildHelper.class
