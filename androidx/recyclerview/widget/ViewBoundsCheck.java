...
class ViewBoundsCheck {
  ...
  View findOneViewWithinBoundFlags(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    int i = this.mCallback.getParentEnd();
    ...
    for (view = null; paramInt1 != paramInt2; view = view1) {
      ...
      this.mBoundFlags.setBounds(j, i, k, m);
      if (paramInt3 != 0) {
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\ViewBoundsCheck.class
