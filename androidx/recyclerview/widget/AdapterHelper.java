    ...
    if (paramUpdateOp.cmd != 1 && paramUpdateOp.cmd != 8) {
      ...
      while (b2 < paramUpdateOp.itemCount) {
        ...
        if (m != 0) {
          ...
          UpdateOp updateOp = obtainUpdateOp(paramUpdateOp.cmd, k, j, paramUpdateOp.payload);
      ...
      recycleUpdateOp(paramUpdateOp);
      if (j > 0) {
        paramUpdateOp = obtainUpdateOp(paramUpdateOp.cmd, k, j, object);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\AdapterHelper.class
