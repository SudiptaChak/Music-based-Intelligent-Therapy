...
public class DefaultItemAnimator extends SimpleItemAnimator {
  ...
  public void runPendingAnimations() {
    int j = this.mPendingRemovals.isEmpty() ^ true;
    int i = this.mPendingMoves.isEmpty() ^ true;
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\DefaultItemAnimator.class
