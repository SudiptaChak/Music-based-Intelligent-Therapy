...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
  ...
  private static abstract class ListIterator<K, V> implements Iterator<Map.Entry<K, V>>, SupportRemove<K, V> {
    ...
    private SafeIterableMap.Entry<K, V> nextNode() {
      SafeIterableMap.Entry<K, V> entry2 = this.mNext;
      SafeIterableMap.Entry<K, V> entry1 = this.mExpectedEnd;
      return (entry2 == entry1 || entry1 == null) ? null : forward(entry2);
    }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\arch\core\internal\SafeIterableMap.class
