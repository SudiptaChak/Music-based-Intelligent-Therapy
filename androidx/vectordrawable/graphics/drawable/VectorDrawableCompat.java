...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  public float getPixelSize() {
    ...
    float f4 = this.mVectorState.mVPathRenderer.mBaseHeight;
    float f3 = this.mVectorState.mVPathRenderer.mViewportWidth;
    float f2 = this.mVectorState.mVPathRenderer.mViewportHeight;
    return Math.min(f3 / f1, f2 / f4);
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\vectordrawable\graphics\drawable\VectorDrawableCompat.class
