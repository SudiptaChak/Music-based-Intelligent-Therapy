...
public class Guideline extends ConstraintWidget {
  ...
  public Rectangle getHead() {
    ...
    int i = getDrawY();
    int k = this.mHeadSize;
    rectangle.setBounds(j - m, i - k * 2, k * 2, k * 2);
    if (getOrientation() == 0) {
      ...
      m = getDrawY();
      i = this.mHeadSize;
      rectangle.setBounds(j - k * 2, m - i, i * 2, i * 2);
    } 
    return this.mHead;
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\constraintlayout\solver\widgets\Guideline.class
