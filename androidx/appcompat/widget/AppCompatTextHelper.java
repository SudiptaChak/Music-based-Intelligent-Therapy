...
class AppCompatTextHelper {
  ...
  private void updateTypefaceAndStyle(Context paramContext, TintTypedArray paramTintTypedArray) {
    ...
    if (paramTintTypedArray.hasValue(R.styleable.TextAppearance_android_fontFamily) || paramTintTypedArray.hasValue(R.styleable.TextAppearance_fontFamily)) {
      ...
      int k = this.mFontWeight;
      int j = this.mStyle;
      if (!paramContext.isRestricted()) {
        ApplyTextViewCallback applyTextViewCallback = new ApplyTextViewCallback(this, k, j);
        try {
          boolean bool1;
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (i != -1) {
      ...
      colorStateList2 = (ColorStateList)TintTypedArray.obtainStyledAttributes(context, i, R.styleable.TextAppearance);
      if (!bool3 && colorStateList2.hasValue(R.styleable.TextAppearance_textAllCaps)) {
        bool1 = colorStateList2.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
        i = 1;
      } else {
        bool1 = false;
        i = 0;
      } 
      updateTypefaceAndStyle(context, (TintTypedArray)colorStateList2);
      if (Build.VERSION.SDK_INT < 23) {
        if (colorStateList2.hasValue(R.styleable.TextAppearance_android_textColor)) {
          tintTypedArray = (TintTypedArray)colorStateList2.getColorStateList(R.styleable.TextAppearance_android_textColor);
        } else {
          tintTypedArray = null;
        } 
        if (colorStateList2.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
          colorStateList1 = colorStateList2.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
        } else {
          colorStateList1 = null;
        } 
        if (colorStateList2.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
          ColorStateList colorStateList = colorStateList2.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
        } else {
      ...
      if (colorStateList2.hasValue(R.styleable.TextAppearance_textLocale)) {
        str2 = colorStateList2.getString(R.styleable.TextAppearance_textLocale);
      } else {
        str2 = null;
      } 
      if (Build.VERSION.SDK_INT >= 26 && colorStateList2.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
        tintTypedArray2 = (TintTypedArray)colorStateList2.getString(R.styleable.TextAppearance_fontVariationSettings);
      } else {
        tintTypedArray2 = null;
      } 
      colorStateList2.recycle();
      colorStateList2 = (ColorStateList)tintTypedArray1;
    ...
    setCompoundDrawables((Drawable)paramAttributeSet, (Drawable)str1, (Drawable)typeface, (Drawable)tintTypedArray2, (Drawable)str2, (Drawable)colorStateList2);
    ...
    j = tintTypedArray3.getDimensionPixelSize(R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
    paramInt = tintTypedArray3.getDimensionPixelSize(R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
    i = tintTypedArray3.getDimensionPixelSize(R.styleable.AppCompatTextView_lineHeight, -1);
    tintTypedArray3.recycle();
    if (j != -1)
      TextViewCompat.setFirstBaselineToTopHeight(this.mView, j); 
    if (paramInt != -1)
      TextViewCompat.setLastBaselineToBottomHeight(this.mView, paramInt); 
    if (i != -1)
  ...
  private static class ApplyTextViewCallback extends ResourcesCompat.FontCallback {
    ...
    private class TypefaceApplyCallback implements Runnable {
      ...
      final AppCompatTextHelper.ApplyTextViewCallback this$0;
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\AppCompatTextHelper.class
