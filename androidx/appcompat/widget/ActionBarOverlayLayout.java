...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (paramInt1 = 0; paramInt1 < paramInt2; paramInt1++) {
      ...
      if (view.getVisibility() != 8) {
        ...
        int i = layoutParams.leftMargin + paramInt3;
        int j = layoutParams.topMargin + paramInt4;
        view.layout(i, j, k + i, m + j);
      } 
    } 
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    setMeasuredDimension(View.resolveSizeAndState(Math.max(i + k + m, getSuggestedMinimumWidth()), paramInt1, j), View.resolveSizeAndState(n, paramInt2, j << 16));
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ActionBarOverlayLayout.class
