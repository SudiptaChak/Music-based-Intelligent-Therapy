...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
  ...
  void adjustDropDownSizeAndPosition() {
    if (this.mDropDownAnchor.getWidth() > 1) {
      ...
      int m = rect.left;
      int k = rect.right;
      this.mSearchSrcTextView.setDropDownWidth(i + m + k + b - j);
    } 
  }
  ...
  private static class UpdatableTouchDelegate extends TouchDelegate {
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      //   144: ifeq -> 187
      //   147: aload_0
      //   148: getfield mActualBounds : Landroid/graphics/Rect;
      //   151: iload #4
      //   153: iload_3
      ...
      //   160: aload_1
      //   161: aload_0
      //   162: getfield mDelegateView : Landroid/view/View;
      //   165: invokevirtual getWidth : ()I
      //   168: iconst_2
      //   169: idiv
      //   170: i2f
      //   171: aload_0
      //   172: getfield mDelegateView : Landroid/view/View;
      ...
      //   199: iload_3
      //   200: aload_0
      //   201: getfield mActualBounds : Landroid/graphics/Rect;
      //   204: getfield top : I
      //   207: isub
      //   208: i2f
      //   209: invokevirtual setLocation : (FF)V
      //   212: aload_0
      //   213: getfield mDelegateView : Landroid/view/View;
      //   216: aload_1
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\SearchView.class
