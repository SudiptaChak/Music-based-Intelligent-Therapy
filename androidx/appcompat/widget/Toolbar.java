...
public class Toolbar extends ViewGroup {
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    int j = tintTypedArray.getDimensionPixelSize(R.styleable.Toolbar_contentInsetRight, 0);
    ensureContentInsets();
    this.mContentInsets.setAbsolute(paramInt, j);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (shouldLayout(this.mExpandedActionView))
      if (j) {
        paramInt4 = layoutChildRight(this.mExpandedActionView, paramInt3, arrayOfInt, bool);
        paramInt1 = paramInt2;
      } else {
        paramInt1 = layoutChildLeft(this.mExpandedActionView, paramInt2, arrayOfInt, bool);
        paramInt4 = paramInt3;
      }  
    paramInt3 = paramInt1;
    paramInt2 = paramInt4;
    if (shouldLayout((View)this.mLogoView))
      if (j) {
        paramInt2 = layoutChildRight((View)this.mLogoView, paramInt4, arrayOfInt, bool);
        paramInt3 = paramInt1;
      } else {
        paramInt3 = layoutChildLeft((View)this.mLogoView, paramInt1, arrayOfInt, bool);
        paramInt2 = paramInt4;
      }  
    boolean bool1 = shouldLayout((View)this.mTitleTextView);
    ...
    if (bool1 || paramBoolean) {
      ...
      if ((bool1 && this.mTitleTextView.getMeasuredWidth() > 0) || (paramBoolean && this.mSubtitleTextView.getMeasuredWidth() > 0)) {
        paramInt4 = 1;
      } else {
        paramInt4 = 0;
      } 
      ...
      if (j) {
        ...
        if (paramBoolean) {
          ...
          k = j + layoutParams1.topMargin;
          i1 = this.mSubtitleTextView.getMeasuredWidth();
          j = this.mSubtitleTextView.getMeasuredHeight();
          this.mSubtitleTextView.layout(paramInt2 - i1, k, paramInt2, j + k);
        ...
        if (paramBoolean) {
          layoutParams1 = (LayoutParams)this.mSubtitleTextView.getLayoutParams();
          i1 = paramInt1 + layoutParams1.topMargin;
          paramInt1 = this.mSubtitleTextView.getMeasuredWidth() + paramInt3;
          k = this.mSubtitleTextView.getMeasuredHeight();
          this.mSubtitleTextView.layout(paramInt3, i1, paramInt1, k + i1);
          k = paramInt1 + this.mTitleMarginEnd;
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    m = i2;
    if (shouldLayout(this.mExpandedActionView)) {
      m = i2 + measureChildCollapseMargins(this.mExpandedActionView, paramInt1, i2, paramInt2, 0, arrayOfInt);
    ...
    j = m;
    if (shouldLayout((View)this.mLogoView)) {
      j = m + measureChildCollapseMargins((View)this.mLogoView, paramInt1, m, paramInt2, 0, arrayOfInt);
      n = Math.max(i1, this.mLogoView.getMeasuredHeight() + getVerticalMargins((View)this.mLogoView));
    ...
    while (j < i3) {
      ...
      if (((LayoutParams)view.getLayoutParams()).mViewType == 0)
        if (!shouldLayout(view)) {
          ...
          k = m + measureChildCollapseMargins(view, paramInt1, m, paramInt2, 0, arrayOfInt);
          i2 = Math.max(n, view.getMeasuredHeight() + getVerticalMargins(view));
    ...
    if (shouldLayout((View)this.mTitleTextView)) {
      ...
      k = getHorizontalMargins((View)this.mTitleTextView);
      j = this.mTitleTextView.getMeasuredHeight();
    ...
    if (shouldLayout((View)this.mSubtitleTextView)) {
      k = Math.max(k, measureChildCollapseMargins((View)this.mSubtitleTextView, paramInt1, m + i1, paramInt2, j + i2, arrayOfInt));
      j += this.mSubtitleTextView.getMeasuredHeight() + getVerticalMargins((View)this.mSubtitleTextView);
    ...
    paramInt1 = View.resolveSizeAndState(Math.max(n + j + i1, getSuggestedMinimumHeight()), paramInt2, i << 16);
    if (shouldCollapse())
      paramInt1 = bool; 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\Toolbar.class
