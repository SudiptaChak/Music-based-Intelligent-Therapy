...
class ViewOverlayApi14 implements ViewOverlayImpl {
  ...
  static class OverlayViewGroup extends ViewGroup {
    ...
    private void getOffset(int[] param1ArrayOfint) {
      ...
      param1ArrayOfint[0] = arrayOfInt1[0] - arrayOfInt2[0];
      param1ArrayOfint[1] = arrayOfInt1[1] - arrayOfInt2[1];
    }
    ...
    public void invalidateChildFast(View param1View, Rect param1Rect) {
      if (this.mHostView != null) {
        ...
        param1Rect.offset(j + arrayOfInt[0], i + arrayOfInt[1]);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\transition\ViewOverlayApi14.class
