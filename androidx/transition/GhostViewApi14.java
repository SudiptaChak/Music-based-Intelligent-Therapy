...
class GhostViewApi14 extends View implements GhostViewImpl {
  ...
  static GhostViewImpl addGhost(View paramView, ViewGroup paramViewGroup) {
    GhostViewApi14 ghostViewApi142 = getGhostView(paramView);
    ...
    if (ghostViewApi142 == null) {
      ...
      if (frameLayout == null)
        return null; 
      ghostViewApi141 = new GhostViewApi14(paramView);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\transition\GhostViewApi14.class
