...
public class ChangeImageTransform extends Transition {
  ...
  private static Matrix centerCropMatrix(ImageView paramImageView) {
    ...
    float f3 = paramImageView.getWidth();
    float f1 = i;
    float f5 = f3 / f1;
    i = drawable.getIntrinsicHeight();
    float f4 = paramImageView.getHeight();
    float f2 = i;
    f5 = Math.max(f5, f4 / f2);
    int j = Math.round((f3 - f1 * f5) / 2.0F);
    i = Math.round((f4 - f2 * f5) / 2.0F);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\transition\ChangeImageTransform.class
