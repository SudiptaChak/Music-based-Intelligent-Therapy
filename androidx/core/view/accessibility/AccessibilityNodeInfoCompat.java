...
public class AccessibilityNodeInfoCompat {
  ...
  private List<CharSequence> extrasCharSequenceList(String paramString) {
    ...
    ArrayList<CharSequence> arrayList2 = this.mInfo.getExtras().getCharSequenceArrayList(paramString);
    ArrayList<CharSequence> arrayList1 = arrayList2;
    if (arrayList2 == null) {
      arrayList1 = new ArrayList();
      this.mInfo.getExtras().putCharSequenceArrayList(paramString, arrayList1);
    } 
    return arrayList1;
  }
  ...
  private void removeCollectedSpans(View paramView) {
    ...
    if (sparseArray != null) {
      ...
      while (b1 < arrayList.size()) {
        sparseArray.remove(((Integer)arrayList.get(b1)).intValue());
        b1++;
      } 
    } 
  }
  ...
  public CharSequence getText() {
    if (hasSpans()) {
      List<Integer> list2 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY");
      ...
      while (b < list2.size()) {
        spannableString.setSpan(new AccessibilityClickableSpanCompat(((Integer)list4.get(b)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer)list2.get(b)).intValue(), ((Integer)list1.get(b)).intValue(), ((Integer)list3.get(b)).intValue());
        b++;
      } 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\view\accessibility\AccessibilityNodeInfoCompat.class
