...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    return (i > 0) ? constrain(paramFloat2 * paramFloat3, f1, paramFloat1) : -constrain(-paramFloat2 * paramFloat3, f1, paramFloat1);
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent) {
    ...
    //   99: i2f
    //   100: aload_0
    //   101: getfield mTarget : Landroid/view/View;
    //   104: invokevirtual getHeight : ()I
    //   107: i2f
    //   108: invokespecial computeTargetVelocity : (IFFF)F
    //   111: fstore_3
    //   112: aload_0
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\widget\AutoScrollHelper.class
