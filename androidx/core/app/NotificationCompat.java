...
public class NotificationCompat {
  ...
  public static class DecoratedCustomViewStyle extends Style {
    ...
    private RemoteViews createRemoteViews(RemoteViews param1RemoteViews, boolean param1Boolean) {
      ...
      //   28: ifeq -> 112
      //   31: aload_0
      //   32: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   35: getfield mActions : Ljava/util/ArrayList;
      //   38: ifnull -> 112
      //   41: aload_0
      //   42: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   75: aload_0
      //   76: aload_0
      //   77: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   80: getfield mActions : Ljava/util/ArrayList;
      //   83: iload #4
      //   85: invokevirtual get : (I)Ljava/lang/Object;
      //   88: checkcast androidx/core/app/NotificationCompat$Action
      //   91: invokespecial generateActionButton : (Landroidx/core/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
      //   94: astore #9
      //   96: aload #8
      //   98: getstatic androidx/core/R$id.actions : I
      //   101: aload #9
      ...
      //   126: istore_3
      //   127: aload #8
      //   129: getstatic androidx/core/R$id.actions : I
      //   132: iload_3
      //   133: invokevirtual setViewVisibility : (II)V
      //   136: aload #8
      //   138: getstatic androidx/core/R$id.action_divider : I
      //   141: iload_3
  ...
  public static abstract class Style {
    ...
    public RemoteViews applyStandardTemplate(boolean param1Boolean1, int param1Int, boolean param1Boolean2) {
      ...
      //   879: goto -> 915
      //   882: aload #9
      //   884: getstatic androidx/core/R$id.time : I
      //   887: iconst_0
      //   888: invokevirtual setViewVisibility : (II)V
      //   891: aload #9
      //   893: getstatic androidx/core/R$id.time : I
      //   896: ldc_w 'setTime'
      //   899: aload_0
      //   900: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   903: invokevirtual getWhenIfShowing : ()J
      //   906: invokevirtual setLong : (ILjava/lang/String;J)V
      //   909: iload #8
      //   911: istore_2
      //   912: goto -> 915
      //   915: getstatic androidx/core/R$id.right_side : I
      //   918: istore #6
      //   920: iload_2
      //   921: ifeq -> 929
      //   924: iconst_0
      ...
      //   940: getstatic androidx/core/R$id.line3 : I
      //   943: istore #6
      //   945: iload #5
      //   947: ifeq -> 956
      //   950: iload #7
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\NotificationCompat.class
