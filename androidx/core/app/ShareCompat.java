...
public final class ShareCompat {
  ...
  public static ComponentName getCallingActivity(Activity paramActivity) {
    ...
    if (componentName2 == null) {
      componentName2 = (ComponentName)paramActivity.getIntent().getParcelableExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY");
  ...
  public static class IntentBuilder {
    ...
    private IntentBuilder(Activity param1Activity) {
      ...
      this.mIntent = intent;
      intent.putExtra("androidx.core.app.EXTRA_CALLING_PACKAGE", param1Activity.getPackageName());
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\ShareCompat.class
