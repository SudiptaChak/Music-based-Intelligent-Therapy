...
public abstract class SharedElementCallback {
  ...
  private static Bitmap createDrawableBitmap(Drawable paramDrawable) {
    ...
    i = (int)(i * f);
    int m = (int)(j * f);
    Bitmap bitmap = Bitmap.createBitmap(i, m, Bitmap.Config.ARGB_8888);
    ...
    paramDrawable.setBounds(k, j, i1, n);
    return bitmap;
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\SharedElementCallback.class
