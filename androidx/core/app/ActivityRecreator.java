...
final class ActivityRecreator {
  ...
  static boolean recreate(Activity paramActivity) {
    ...
    if (performStopActivity2ParamsMethod == null && performStopActivity3ParamsMethod == null)
      return false; 
    try {
      Object object2 = tokenField.get(paramActivity);
      if (object2 == null)
        return false; 
      Object object1 = mainThreadField.get(paramActivity);
      if (object1 == null)
        return false; 
      ...
      super(lifecycleCheckCallbacks, object2);
      handler.post(null);
    } finally {
      paramActivity = null;
    } 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\ActivityRecreator.class
