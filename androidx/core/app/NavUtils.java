...
public final class NavUtils {
  ...
  public static String getParentActivityName(Context paramContext, ComponentName paramComponentName) throws PackageManager.NameNotFoundException {
    ...
    ActivityInfo activityInfo = packageManager.getActivityInfo(paramComponentName, 640);
    if (Build.VERSION.SDK_INT >= 16) {
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\NavUtils.class
