...
public final class ColorUtils {
  ...
  public static void RGBToHSL(int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOffloat) {
    ...
    float f5 = Math.max(f1, Math.max(f3, f6));
    float f7 = Math.min(f1, Math.min(f3, f6));
    float f2 = f5 - f7;
    float f4 = (f5 + f7) / 2.0F;
    if (f5 == f7) {
      f2 = 0.0F;
  ...
  public static int blendARGB(int paramInt1, int paramInt2, float paramFloat) {
    ...
    float f4 = Color.green(paramInt2);
    float f7 = Color.blue(paramInt1);
    float f9 = Color.blue(paramInt2);
    return Color.argb((int)(f2 * f8 + f3 * paramFloat), (int)(f5 * f8 + f1 * paramFloat), (int)(f6 * f8 + f4 * paramFloat), (int)(f7 * f8 + f9 * paramFloat));
  }
  ...
  public static double calculateContrast(int paramInt1, int paramInt2) {
    if (Color.alpha(paramInt2) == 255) {
      ...
      double d2 = calculateLuminance(i) + 0.05D;
      double d1 = calculateLuminance(paramInt2) + 0.05D;
  ...
  public static int compositeColors(int paramInt1, int paramInt2) {
    int i = Color.alpha(paramInt2);
    int k = Color.alpha(paramInt1);
    int j = compositeAlpha(k, i);
    return Color.argb(j, compositeComponent(Color.red(paramInt1), k, Color.red(paramInt2), i, j), compositeComponent(Color.green(paramInt1), k, Color.green(paramInt2), i, j), compositeComponent(Color.blue(paramInt1), k, Color.blue(paramInt2), i, j));
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\graphics\ColorUtils.class
