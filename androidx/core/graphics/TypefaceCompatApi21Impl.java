...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
  ...
  private static void init() {
    ...
    try {
      ...
      Constructor<?> constructor = clazz1.getConstructor(new Class[0]);
      Method method1 = clazz1.getMethod("addFontWeightStyle", new Class[] { String.class, int.class, boolean.class });
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\graphics\TypefaceCompatApi21Impl.class
