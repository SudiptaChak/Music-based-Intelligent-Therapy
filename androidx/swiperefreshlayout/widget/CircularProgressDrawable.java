  ...
  private static class Ring {
    ...
    void drawTriangle(Canvas param1Canvas, float param1Float1, float param1Float2, RectF param1RectF) {
      if (this.mShowArrow) {
        ...
        float f4 = Math.min(param1RectF.width(), param1RectF.height()) / 2.0F;
        float f2 = this.mArrowWidth * this.mArrowScale / 2.0F;
        this.mArrow.moveTo(0.0F, 0.0F);
        this.mArrow.lineTo(this.mArrowWidth * this.mArrowScale, 0.0F);
        path = this.mArrow;
        float f1 = this.mArrowWidth;
        float f3 = this.mArrowScale;
        path.lineTo(f1 * f3 / 2.0F, this.mArrowHeight * f3);
        this.mArrow.offset(f4 + param1RectF.centerX() - f2, param1RectF.centerY() + this.mStrokeWidth / 2.0F);
        this.mArrow.close();
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\swiperefreshlayout\widget\CircularProgressDrawable.class
