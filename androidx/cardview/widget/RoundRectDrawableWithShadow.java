...
class RoundRectDrawableWithShadow extends Drawable {
  ...
  private void buildShadowCorners() {
    ...
    paint.setShader((Shader)new RadialGradient(0.0F, 0.0F, f3 + f1, new int[] { j, j, i }, new float[] { 0.0F, f2, 1.0F }, tileMode));
  ...
  private void drawShadow(Canvas paramCanvas) {
    ...
    float f3 = f2 + this.mInsetShadow + this.mRawShadowSize / 2.0F;
    ...
    if (this.mCardBounds.height() - f2 > 0.0F) {
      bool = true;
    } else {
      bool = false;
    } 
    ...
    if (i)
      paramCanvas.drawRect(0.0F, f1, this.mCardBounds.width() - f2, -this.mCornerRadius, this.mEdgeShadowPaint); 
    ...
    paramCanvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
    if (i)
      paramCanvas.drawRect(0.0F, f1, this.mCardBounds.width() - f2, -this.mCornerRadius + this.mShadowSize, this.mEdgeShadowPaint); 
    paramCanvas.restoreToCount(j);
    ...
    paramCanvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
    if (bool)
      paramCanvas.drawRect(0.0F, f1, this.mCardBounds.height() - f2, -this.mCornerRadius, this.mEdgeShadowPaint); 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\cardview\widget\RoundRectDrawableWithShadow.class
