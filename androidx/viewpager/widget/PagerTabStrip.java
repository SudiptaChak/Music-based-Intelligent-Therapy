...
public class PagerTabStrip extends PagerTitleStrip {
  ...
  protected void onDraw(Canvas paramCanvas) {
    ...
    float f4 = (n + i1);
    float f2 = i;
    paramCanvas.drawRect(f3, f1, f4, f2, this.mTabPaint);
    if (this.mDrawFullUnderline) {
      this.mTabPaint.setColor(0xFF000000 | this.mIndicatorColor & 0xFFFFFF);
      paramCanvas.drawRect(getPaddingLeft(), (i - this.mFullUnderlineHeight), (getWidth() - getPaddingRight()), f2, this.mTabPaint);
    } 
  }
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    int n = j - this.mIndicatorHeight;
    rect.set(m - i1, n, i + k, j);
    super.updateTextPositions(paramInt, paramFloat, paramBoolean);
    this.mTabAlpha = (int)(Math.abs(paramFloat - 0.5F) * 2.0F * 255.0F);
    rect.union(this.mCurrText.getLeft() - this.mTabPadding, n, this.mCurrText.getRight() + this.mTabPadding, j);
    invalidate(rect);
  }
}


/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\viewpager\widget\PagerTabStrip.class
