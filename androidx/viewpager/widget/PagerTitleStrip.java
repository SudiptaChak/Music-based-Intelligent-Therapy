...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    int i3 = this.mCurrText.getMeasuredWidth();
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\viewpager\widget\PagerTitleStrip.class
