...
public class ViewPager extends ViewGroup {
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    if (paramInt2 > 0 && !this.mItems.isEmpty()) {
      if (!this.mScroller.isFinished()) {
        ...
        scrollTo((int)(getScrollX() / (paramInt2 - k - i + paramInt4) * (paramInt1 - m - j + paramInt3)), getScrollY());
      } 
    } else {
      float f;
  ...
  protected void onDraw(Canvas paramCanvas) {
    ...
    if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
      ...
      int i = itemInfo.position;
      int j = ((ItemInfo)this.mItems.get(n - 1)).position;
      while (i < j) {
        float f;
        ItemInfo itemInfo1;
        ...
        if (view.getVisibility() != 8) {
          ...
          if (layoutParams != null) {
            ...
            if (layoutParams.isDecor) {
              ...
              view.measure(View.MeasureSpec.makeMeasureSpec(k, i1), View.MeasureSpec.makeMeasureSpec(n, m));
              if (bool) {
                n = paramInt2 - view.getMeasuredHeight();
                i1 = paramInt1;
              } else {
                i1 = paramInt1;
                n = paramInt2;
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\viewpager\widget\ViewPager.class
