...
public abstract class WakefulBroadcastReceiver extends BroadcastReceiver {
  ...
  public static ComponentName startWakefulService(Context paramContext, Intent paramIntent) {
    synchronized (sActiveWakeLocks) {
      ...
      if (i <= 0)
        mNextId = 1; 
      paramIntent.putExtra("androidx.contentpager.content.wakelockid", j);
      ...
      sActiveWakeLocks.put(j, wakeLock);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\legacy\content\WakefulBroadcastReceiver.class
