  ...
  final class EntrySet implements Set<Map.Entry<K, V>> {
    ...
    public int hashCode() {
      ...
      while (j >= 0) {
        int k;
        int m;
        Object object2 = MapCollections.this.colGetEntry(j, 0);
        Object object1 = MapCollections.this.colGetEntry(j, 1);
        if (object2 == null) {
          k = 0;
        } else {
          k = object2.hashCode();
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\collection\MapCollections.class
