  ...
  public E removeAt(int paramInt) {
    ...
    if (i <= 1) {
      ...
      if (k > 8 && i < arrayOfInt.length / 3) {
        ...
        if (paramInt < j) {
          i = paramInt + 1;
          System.arraycopy(arrayOfInt1, i, this.mHashes, paramInt, j - paramInt);
          System.arraycopy(arrayOfObject1, i, this.mArray, paramInt, this.mSize - paramInt);
        } 
      } else {
        j = this.mSize - 1;
        this.mSize = j;
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\collection\ArraySet.class
