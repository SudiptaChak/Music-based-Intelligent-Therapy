...
public class SimpleArrayMap<K, V> {
  ...
  public V put(K paramK, V paramV) {
    ...
    if (m < k) {
      ...
      Object[] arrayOfObject = this.mArray;
      System.arraycopy(arrayOfObject, m << 1, arrayOfObject, i << 1, this.mSize - m << 1);
    } 
    int i = this.mSize;
    if (k == i) {
      int[] arrayOfInt = this.mHashes;
      ...
      if (n > 8 && j < arrayOfInt.length / 3) {
        ...
        if (j == this.mSize) {
          ...
          if (paramInt < m) {
            ...
            int[] arrayOfInt1 = this.mHashes;
            i = m - paramInt;
            System.arraycopy(arrayOfInt, n, arrayOfInt1, paramInt, i);
            System.arraycopy(arrayOfObject1, n << 1, this.mArray, k, i << 1);
          } 
        } else {
          throw new ConcurrentModificationException();
        } 
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\androidx\collection\SimpleArrayMap.class
