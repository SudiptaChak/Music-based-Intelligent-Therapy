...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
  ...
  void getPadding(Rect paramRect) {
    if (this.shadowViewDelegate.isCompatPaddingEnabled()) {
      ...
      int j = (int)Math.ceil(ShadowDrawableWrapper.calculateHorizontalPadding(f2, f1, false));
      int i = (int)Math.ceil(ShadowDrawableWrapper.calculateVerticalPadding(f2, f1, false));
  ...
  void setBackgroundDrawable(ColorStateList paramColorStateList1, PorterDuff.Mode paramMode, ColorStateList paramColorStateList2, int paramInt) {
    ...
    if (paramInt > 0) {
      ...
      LayerDrawable layerDrawable = new LayerDrawable(new Drawable[] { (Drawable)this.borderDrawable, this.shapeDrawable });
    } else {
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\floatingactionbutton\FloatingActionButtonImplLollipop.class
