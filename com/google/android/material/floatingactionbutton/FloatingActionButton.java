...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
  ...
  public FloatingActionButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    float f2 = typedArray.getDimension(R.styleable.FloatingActionButton_elevation, 0.0F);
    float f3 = typedArray.getDimension(R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0F);
  ...
  protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
    ...
    private void offsetIfNeeded(CoordinatorLayout param1CoordinatorLayout, FloatingActionButton param1FloatingActionButton) {
      ...
      if (rect != null && rect.centerX() > 0 && rect.centerY() > 0) {
        ...
        int m = param1FloatingActionButton.getRight();
        int i = param1CoordinatorLayout.getWidth();
  ...
  private class ShadowDelegateImpl implements ShadowViewDelegate {
    ...
    public void setShadowPadding(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
      ...
      floatingActionButton.setPadding(param1Int1 + floatingActionButton.imagePadding, param1Int2 + FloatingActionButton.this.imagePadding, param1Int3 + FloatingActionButton.this.imagePadding, param1Int4 + FloatingActionButton.this.imagePadding);
    }
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\floatingactionbutton\FloatingActionButton.class
