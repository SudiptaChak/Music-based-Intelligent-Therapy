...
public class CircularBorderDrawable extends Drawable {
  ...
  private Shader createGradientShader() {
    ...
    int k = ColorUtils.compositeColors(this.topInnerStrokeColor, this.currentBorderTintColor);
    int j = ColorUtils.compositeColors(ColorUtils.setAlphaComponent(this.topInnerStrokeColor, 0), this.currentBorderTintColor);
    ...
    return (Shader)new LinearGradient(0.0F, f3, 0.0F, f1, new int[] { i, k, j, m, n, i1 }, new float[] { 0.0F, f2, 0.5F, 0.5F, 1.0F - f2, 1.0F }, tileMode);
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\internal\CircularBorderDrawable.class
