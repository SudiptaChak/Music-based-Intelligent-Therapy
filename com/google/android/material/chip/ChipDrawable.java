...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
  ...
  private void drawText(Canvas paramCanvas, Rect paramRect) {
    if (this.unicodeWrappedText != null) {
      ...
      int k = Math.round(getTextWidth());
      int i = Math.round(this.rectF.width());
      int j = 0;
      if (k > i) {
        i = 1;
      } else {
      ...
      if (i != 0) {
        ...
        if (this.truncateAt != null)
          charSequence1 = TextUtils.ellipsize(charSequence2, this.textPaint, this.rectF.width(), this.truncateAt); 
      } 
  ...
  private boolean onStateChange(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    ...
    if (colorStateList2 != null) {
      i = colorStateList2.getColorForState(paramArrayOfint1, this.currentChipBackgroundColor);
    } else {
      i = 0;
    } 
    ...
    if (colorStateList2 != null) {
      i = colorStateList2.getColorForState(paramArrayOfint1, this.currentChipStrokeColor);
    } else {
      i = 0;
    } 
    ...
    if (colorStateList2 != null) {
      i = colorStateList2.getColorForState(paramArrayOfint1, this.currentCompatRippleColor);
    } else {
      i = 0;
    } 
    boolean bool1 = bool2;
    ...
    if (this.currentChecked != bool2 && this.checkedIcon != null) {
      float f = calculateChipIconWidth();
      this.currentChecked = bool2;
    ...
    if (colorStateList1 != null)
      j = colorStateList1.getColorForState(paramArrayOfint1, this.currentTint); 
  ...
  public void setDelegate(Delegate paramDelegate) {
    this.delegate = new WeakReference<Delegate>(paramDelegate);
  }
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\chip\ChipDrawable.class
