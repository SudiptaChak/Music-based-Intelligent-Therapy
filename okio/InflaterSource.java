      ...
      if (!this.closed) {
        ...
        while (true) {
          ...
          try {
            ...
            i = this.inflater.inflate(segment.data, segment.limit, 2048 - segment.limit);
            if (i > 0) {
              segment.limit += i;
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\okio\InflaterSource.class
