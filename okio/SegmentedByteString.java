...
final class SegmentedByteString extends ByteString {
  ...
  void write(Buffer paramBuffer) {
    ...
    for (i = 0; b < j; i = k) {
      ...
      int m = arrayOfInt[j + b];
      int k = arrayOfInt[b];
      Segment segment = new Segment(this.segments[b], m, m + k - i);
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\okio\SegmentedByteString.class
