...
public final class Http2 implements Variant {
    ...
    static {
      ...
      while (true) {
        ...
        if (b1 < arrayOfString1.length) {
          arrayOfString1[b1] = String.format("%8s", new Object[] { Integer.toBinaryString(b1) }).replace(' ', '0');
          b1++;
          continue;
        } 
        ...
        for (b1 = 0; b1 < 1; b1++) {
          ...
          arrayOfString[b | 0x8] = stringBuilder.toString();
        } 
        ...
        while (true) {
          ...
          if (b1 < 3) {
            ...
            for (b = 0; b < 1; b++) {
              ...
              stringBuilder.append(FLAGS[i]);
              stringBuilder.append("|PADDED");
              arrayOfString[k | 0x8] = stringBuilder.toString();
            } 
            b1++;
            continue;
          } 
  ...
  static final class Reader implements FrameReader {
    ...
    private List<Header> readHeaderBlock(int param1Int1, short param1Short, byte param1Byte, int param1Int2) throws IOException {
      ...
      this.continuation.padding = param1Short;
      this.continuation.flags = param1Byte;
    ...
    private void readSettings(FrameReader.Handler param1Handler, int param1Int1, byte param1Byte, int param1Int2) throws IOException {
      if (param1Int2 == 0) {
        ...
        if (param1Int1 % 6 == 0) {
          ...
          for (param1Int2 = 0; param1Int2 < param1Int1; param1Int2 += 6) {
            short s;
  ...
  static final class Writer implements FrameWriter {
    ...
    void headers(boolean param1Boolean, int param1Int, List<Header> param1List) throws IOException {
      if (!this.closed) {
        ...
        int j = (int)Math.min(this.maxFrameSize, l1);
        long l2 = j;
        int i = l1 cmp l2;
        if (i == 0) {
          b1 = 4;
        ...
        if (param1Boolean)
          b2 = (byte)(b1 | 0x1); 
        frameHeader(param1Int, j, (byte)1, b2);
    ...
    public void pushPromise(int param1Int1, int param1Int2, List<Header> param1List) throws IOException {
      ...
      //   6: ifne -> 126
      //   9: aload_0
      //   10: getfield hpackWriter : Lokhttp3/internal/framed/Hpack$Writer;
      //   13: aload_3
...
/* Location:              C:\Users\admin\Desktop\Test\dex-tools-v2.4\classes-dex2jar.jar!\okhttp3\internal\framed\Http2.class
